...
- Registro de familias
  - Errores
    ...
    - Creo que el responsiveness de la pagina podría estar mas pulido. Hay paginas que en la versión móvil se ven regular, sobre todo por el header. Quizás sería mejor idea para el header y las secciones implementar un menú de hamburguesa que se despliegue en vez de comprimirlas todas. Después en las pantallas grandes la aplicación ocupa todo el ancho de la pantalla, lo cual no es muy cómodo, podría ser buena idea utilizar media queries de css para acotar las paginas para tener una anchura máxima.



1. **Reducir la lista a los más prometedores**

Una vez que ya conocemos los distintos segmentos en los que podemos enfocarnos, podemos llevar a cabo un análisis para saber cuál es el que mejor se adapta a nuestro software y cuál es el que nos puede proporcionar más beneficios.

|Segmentos|Tamaño de mercado|Barreras de entrada|Competencia|
| - | - | - | - |
|Centros educativos públicos|19\.121|<p>Procesos de Contratación Pública.</p><p></p><p>Competencia y Preferencias con proveedores Establecidos</p><p></p><p>Ciclos de Toma de Decisiones Lentos.</p><p></p><p></p>|<p>Séneca (junta de Andalucía) </p><p></p><p>Google Classroom </p><p></p><p>Blackboard </p><p></p><p>Chamilo</p><p></p><p>Moodle</p><p></p><p>LearnPress</p>|
|Centros educativos privados|9.335|<p>Integración con Sistemas Existentes</p><p></p><p>Competencia en el Mercado</p><p></p><p>Adaptación a Necesidades Específicas</p>|<p>Google Clasroom </p><p></p><p>Blackboard </p><p></p><p>Chamilo</p><p></p><p>Moodle</p><p></p><p>LearnPress</p>|
|<p>Centros educativos solidarios</p><p>(ONG)</p>|900|<p>Capacitación y Soporte</p><p></p><p>Necesidades Específicas del centro</p><p></p><p>Recursos Limitados</p>|<p>Google Clasroom </p><p></p><p>Blackboard </p><p></p><p>Chamilo</p><p></p><p>Moodle</p><p></p><p>LearnPress</p>|
|Academias no regladas|2000|<p>Demostración de Resultados con otras academias.</p><p></p><p>Personalización y Flexibilidad</p><p></p><p>Capacitación y Soporte</p>|<p>Google Clasroom </p><p></p><p>Blackboard </p><p></p><p>Chamilo</p><p></p><p>Moodle</p><p></p><p>LearnPress</p>|




1. **Seleccionar el que tiene el mayor potencial**

Una vez que hemos visto todos los segmentos que tenemos y haberlos clasificado, podemos decir que actualmente no nos interesa centrarnos de primera en los centros educativos públicos ni privados, ya que estos cuentan con herramientas que les proporcionan empresas externas como Classroom o propias de la comunidad autónoma como Séneca. Además, estos no precisan del manejo de voluntarios ni de socios.

Nuestro nicho de mercado, por tanto, podría centrarse en el segmento de academias no regladas y entidades solidarias. Con respecto al primero, tendríamos que hacer algunas modificaciones en el código, para no mostrar las funcionalidades de voluntarios y socios, pero aun así con unas pequeñas modificaciones se podría adecuar el software a ellos.

En conclusión, el segmento que más nos interesa y el que hemos decidido de priorizar es el de centros docentes solidarios, ya que no tendríamos que modificar nuestras implementaciones, pues nuestro software está centrado en satisfacer los requisitos de estas últimas. Además de que ya contamos con una ONG llamada Manos abiertas con norte, la cual usara nuestro producto, esto nos servirá como publicidad, puesto que puede hacer que otros centros docentes similares se interesen por nuestro software.
...
1. **Selección de palabras clave primarias y secundarias.**
   ...
   En segundo lugar, también dejaremos como claves secundarias a recursos educativos porque el volumen local es pequeño y no muchas personas intentan buscar clases por esta palabra, ya que las variaciones lo demuestran.
...
Estas estimaciones se basan en suposiciones realistas sobre la tasa de crecimiento y el comportamiento del usuario en las redes sociales, pero es importante monitorear y ajustar la estrategia según los resultados reales obtenidos durante la ejecución de la campaña.
