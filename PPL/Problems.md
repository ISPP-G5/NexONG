...
- Finalmente, llegados el jueves 19 de abril, el grupo de tarde realizó el formulario por lo que no llegaron a incumplir totalmente el acuerdo. Una semana después concretamente el miércoles 24 de abril el grupo de tarde nos paso el enlace de su despliegue y pudimos ejercer de usuarios piloto. El ejercer de usuarios pilotos no ha sido una tarea fácil ya que la aplicación poseía muchos problemas tanto de carga, como funcionales y mechos miembros del equipo no entendían si eran problema nuestro o por parte de ellos.
